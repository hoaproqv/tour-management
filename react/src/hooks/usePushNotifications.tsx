  ...
  useEffect(() => {
    const requestPermissionAndGetToken = async () => {
      try {
        ...
        if (permission === "granted") {
          ...
          if (currentToken) {
            ...
            try {
              ...
              message.error("Lỗi kết nối Backend FCM: " + (err.message || "Unknown error"));
            }
          } else {
            console.warn(
              "Không có Registration Token nào khả dụng. Yêu cầu permission để khởi tạo token."
            );
            message.warning("Không tạo được Token từ Firebase. Vui lòng kiểm tra lại cấu hình!");
          }
        } else {
          ...
          Modal.warning({
            ...
            content: (
              <div>
                <p>Bạn vừa từ chối nhận thông báo. Để nhận thông báo chuyến đi sau này, bạn cần bật lại quyền trong cài đặt trình duyệt:</p>
                <ol className="mt-2 text-sm">
                  <li>Bấm vào biểu tượng ổ khóa 🔒 cạnh thanh địa chỉ.</li>
                  <li>Tìm mục <b>Thông báo (Notifications)</b>.</li>
                  <li>Chuyển sang <b>Cho phép (Allow)</b>.</li>
        ...
        message.error("Lỗi khởi tạo Firebase: " + (error.message || "Lỗi không xác định"));
      }
    };
    ...
    if (Notification.permission === "default") {
      ...
      notification.info({
        ...
        description: "Bạn có muốn nhận thông báo (Push Notification) khi có cập nhật điểm danh hoặc chuyến đi không?",
        btn: (
          <div onClick={() => {
      ...
      Modal.warning({
        ...
        content: (
          <div>
            <p>Hệ thống không thể gửi thông báo vì trình duyệt của bạn đang chặn quyền.</p>
            <ol className="mt-2 text-sm">
              <li>Bấm vào biểu tượng ổ khóa 🔒 cạnh thanh địa chỉ.</li>
              <li>Tìm mục <b>Thông báo (Notifications)</b>.</li>
              <li>Chuyển sang <b>Cho phép (Allow)</b>.</li>
